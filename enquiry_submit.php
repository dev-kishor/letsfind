    ...
    if ($enquiry_res) {
        if ($service_name == NULL) {
            ...
            $message2 = stripslashes(str_replace(
                ...
                array('' . $admin_site_name . '', '' . $first_name . '', '' . $email_id . '', '' . $star_password . '', '' . $admin_footer_copyright . '', '' . $admin_address . '', '' . $webpage_full_link . '', '' . $enquiry_name . '', '' . $enquiry_mobile . '', '' . $enquiry_email . '', '' . $enquiry_message . '', '' . $admin_primary_email . ''),
