                        ...
                        <ul>
                            <li class="sr-sea">
                                <select class="chosen-select" id="expert-select-search1" name="expert-select-search">
                                    <?php
                                    $single_record_query = getAllActiveExpertCategoriesPos();
                                    $single_record = mysqli_fetch_array($single_record_query);
                                    ?>
                                     <option value="<?php echo $single_record["category_slug"]; ?>"><?php echo $single_record["category_name"]; ?></option>
                                    <?php
                                    ...
                                    ?>
                                        <option value="<?php echo $search_category_slug; ?>"><?php echo $search_category_name; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <li>
                                <div class="land-pack-grid">
                                    <div class="land-pack-grid-img">
                                        <img src="<?php echo $slash; ?>service-experts/images/services/<?php echo $expert_categories_row['category_image']; ?>" alt="">
                                    </div>
                                    <div class="land-pack-grid-text">
                                        <h4><?php echo $category_name; ?><span class="dir-ho-cat"><?php echo $BIZBOOK['SERVICE-EXPERTS-EXPERTS']; ?> <?php echo $total_experts_category; ?></span>
                                        </h4>
                                    </div>
                                    <a href="<?php echo $ALL_EXPERTS_URL . urlModifier($expert_categories_row['category_slug']); ?>" class="land-pack-grid-btn"><?php echo $BIZBOOK['SERVICE-EXPERT-VIEW-ALL']; ?></a>
                                </div>
                            </li>
                        <?php
                        }
                ...
                <div class="hom2-cus-sli">
                    <ul class="multiple-items">
                        ...
                        ?>
                            <li>
                                <div class="testmo">
                                    <img src="<?php echo $slash; ?>images/user/<?php if (($revuser_details_row['profile_image'] == NULL) || empty($revuser_details_row['profile_image'])) {
    ...
    <div class="str count">
        <div class="container">
            <div class="row">
                    ...
                    <div class="how-wrks-inn">
                        <ul>
                            <li>
                                <div>
                                    <span>1</span>
                                    <img loading="lazy" src="<?php echo $slash; ?>images/icon/how1.png" alt="">
                            ...
                            <li>
                                <div>
                                    <span>2</span>
                                    <img loading="lazy" src="<?php echo $slash; ?>images/icon/how2.png" alt="">
                            ...
                            <li>
                                <div>
                                    <span>3</span>
                                    <img loading="lazy" src="<?php echo $slash; ?>images/icon/how3.png" alt="">
                            ...
                            <li>
                                <div>
                                    <span>4</span>
                                    <img loading="lazy" src="<?php echo $slash; ?>images/icon/how4.png" alt="">
                ...
                <div class="mob-app">
                    <div class="lhs">
                        <img loading="lazy" src="<?php echo $slash; ?>images/mobile.png" alt="">
                    </div>
                    <div class="rhs">
                        <h2><?php echo $BIZBOOK['HOM-APP-TIT']; ?>
                            <span><?php echo $BIZBOOK['HOM-APP-TIT-SUB']; ?></span>
                        </h2>
                        <ul>
                        ...
                        <a href="#"><img loading="lazy" src="<?php echo $slash; ?>images/android.png" alt=""> </a>
                        <a href="#"><img loading="lazy" src="<?php echo $slash; ?>images/apple.png" alt=""> </a>
                    </div>
                </div>
            </div>
        </div>
