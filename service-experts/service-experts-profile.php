                ...
                <div class="lhs">
                    <div class="jpro-bd-chat">
                        <h4><?php echo $BIZBOOK['SERVICE-EXPERT-BOOK-THIS']; ?>
                            (<b><?php echo $expert_profile_row['profile_name']; ?></b>)
                            <?php echo $BIZBOOK['SERVICE-EXPERT-SERVICE-EXPERT-TEXT']; ?>
                            <span data-toggle="modal" data-target="#expfrm"><?php echo $BIZBOOK['SERVICE-EXPERT-BOOK-NOW']; ?></span>
                        </h4>
                    </div>
                    <!--START-->
                    <div class="profile">
                        ...
                        <div class="jpro-ban-bg-img">
                            <span><?php echo $BIZBOOK['SERVICE-EXPERT-STATUS']; ?>: <b><?php
                                                                                        if ($expert_profile_row['expert_availability_status'] == 0) {
                                                                                            echo $BIZBOOK['SERVICE-EXPERT-AVAILABLE-LABEL'];
                                                                                        } elseif ($expert_profile_row['expert_availability_status'] == 1) {
                                                                                            echo $BIZBOOK['SERVICE-EXPERT-BUSY-LABEL'];
                                                                                        } elseif ($expert_profile_row['expert_availability_status'] == 2) {
                                                                                            echo $BIZBOOK['SERVICE-EXPERT-CLOSED-TODAY-LABEL'];
                                                                                        } ?></b></span>
                            <img src="<?php echo $slash; ?>service-experts/images/services/<?php echo $expert_profile_row['cover_image']; ?>" alt="">
                        </div>
                        <div class="jpro-ban-tit">
                            <div class="s1">
                                <img src="<?php echo $slash; ?>service-experts/images/services/<?php echo $expert_profile_row['profile_image']; ?>" alt="">
                            </div>
                            <div class="s2">
                            ...
                            <div class="s3">
                                <span class="cta fol comm-msg-act-btn" data-toggle="modal" data-target="#expfrm"><?php echo $BIZBOOK['SERVICE-EXPERT-BOOK-NOW']; ?></span>
                                <span class="cta" data-toggle="modal" data-target="#expwrirevi"><?php echo $BIZBOOK['LISTING_DETAILS_WRITE_REVIEW']; ?></span>
                            </div>
                        </div>
                    </div>
                    <!--END-->
                    ...
                    <div class="jb-pro-bio">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span><?php echo $expert_profile_row['years_of_experience']; ?>
                                    <?php echo $BIZBOOK['SERVICE-EXPERT-YEARS-TEXT']; ?></span>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span><?php echo $expert_profile_row['available_time_start']; ?>
                                    <?php echo $BIZBOOK['SERVICE-EXPERT-TO-TEXT']; ?>
                                    <?php echo $expert_profile_row['available_time_end']; ?></span>
                            </li>
                        </ul>
                    </div>
                    <!--END-->
                    ...
                    <div class="jpro-bd">
                        ...
                        ?>
                            ...
                            ?>
                                <div class="spa-first-review"><?php echo $BIZBOOK['SERVICE-EXPERT-BE-FIRST-REVIEW']; ?></div>
                        <?php
                            }
                        }
                        ?>
                    ...
                    ?>
                        <div class="ud-rhs-promo exp-rel-supp">
                            ...
                            <ul>
                                ...
                                ?>
                                    <li>
                                        <i class="material-icons">local_phone</i>: <a href="tel:<?php echo $footer_row['admin_service_expert_mobile']; ?>"><?php echo $footer_row['admin_service_expert_mobile']; ?></a>
                                    </li>
                                <?php
                                }
                                ...
                                ?>
                                    <li>
                                        <i class="material-icons">email</i>: <a href="mail:<?php echo $footer_row['admin_service_expert_email']; ?>"><?php echo $footer_row['admin_service_expert_email']; ?></a>
                                    </li>
                                <?php
                                }
                                ...
                                ?>
                                    <li>
                                        <i class="material-icons">chat_bubble_outline</i>: <a href="tel:<?php echo $footer_row['admin_service_expert_whatsapp']; ?>"><?php echo $footer_row['admin_service_expert_whatsapp']; ?>
                                ...
                                ?>
                                    ...
                                    <li>
                                        <div class="hot-page2-hom-pre-1">
                                            <img loading="lazy" src="<?php echo $slash; ?>service-experts/images/services/<?php echo $except_list_row['profile_image']; ?>" alt="">
                                        </div>
                        ...
                        <div class="hot-page2-hom-pre">
                            ...
                            <ul>
                                ...
                                ?>
                                    <li>
                                        <div class="hot-page2-hom-pre-1">
                                            <img loading="lazy" src="<?php echo $slash; ?>service-experts/images/services/<?php echo $except_category_row['category_image']; ?>" alt="">
                                        </div>
                                        <div class="hot-page2-hom-pre-2">
                                            <h5><?php echo $except_category_name; ?></h5>
                                            <span><b><?php echo AddingZero_BeforeNumber($total_experts_category); ?>
                                                    <?php echo $BIZBOOK['SERVICE-EXPERTS-EXPERTS']; ?></b>,
                                                <?php echo AddingZero_BeforeNumber(getCategoryCountFinishedExpertEnquiries($except_category_id)); ?>
                                                <?php echo $BIZBOOK['SERVICE-EXPERT-SERVICES-DONE']; ?></span>
                                        </div>
        ...
        <div class="modal fade" id="expfrm">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal Header -->
                    <div class="quote-pop">
                        <div id="expert_detail_enq_success" class="log" style="display: none;">
                            <p><?php echo $BIZBOOK['SERVICE_EXPERT_ENQUIRY_SUCCESSFUL_MESSAGE']; ?></p>
                        </div>
                        <div id="expert_detail_enq_same" class="log" style="display: none;">
                            <p><?php echo $BIZBOOK['SERVICE_EXPERT_ENQUIRY_OWN_JOB_MESSAGE']; ?></p>
                        </div>
                        <div id="expert_detail_enq_fail" class="log" style="display: none;">
                            <p><?php echo $BIZBOOK['OOPS_SOMETHING_WENT_WRONG']; ?></p>
                        </div>
                        <div class="ser-exp-wel"><?php echo $BIZBOOK['SERVICE-EXPERT-HEY-LABEL']; ?>
                            <b><?php echo $expert_profile_row['profile_name']; ?></b>
                        </div>
                        <form method="post" name="expert_detail_enquiry_form" id="expert_detail_enquiry_form">
                            <input type="hidden" class="form-control" name="available_time_start" id="available_time_start" value="<?php echo $expert_profile_row['available_time_start']; ?>" placeholder="" required>
                            <input type="hidden" class="form-control" name="available_time_end" id="available_time_end" value="<?php echo $expert_profile_row['available_time_end']; ?>" placeholder="" required>
                            <input type="hidden" class="form-control" name="expert_id" id="expert_id" value="<?php echo $expert_id; ?>" placeholder="" required>
                            <input type="hidden" class="form-control" name="expert_user_id" id="expert_user_id" value="<?php echo $expert_profile_user_id; ?>" placeholder="" required>
                            ...
                            <div class="form-group col-md-6 serex-date">
                                <input type="text" class="form-control enquiry_date_expert" name="enquiry_date" onchange="checkExpertAv()" placeholder="<?php echo $BIZBOOK['SERVICE-EXPERT-PREFERRED-DATE']; ?>" id="newdate">
                            </div>
                            <div class="form-group col-md-6 serex-time selecttimeslotdiv">
                                <select class="selecttimeslot" id="selecttimeslot" name="enquiry_time">
                            ...
                            <button <?php if ($session_user_id == NULL || empty($session_user_id)) {
                                    ?> disabled="disabled" <?php } ?> type="submit" id="expert_detail_enquiry_submit" name="expert_detail_enquiry_submit" class="btn btn-primary"><?php if ($session_user_id == NULL || empty($session_user_id)) {
                                                                                                                                                                                    ?>
                                    <?php echo $BIZBOOK['LOG_IN_TO_SUBMIT']; ?>
                                    <?php } else { ?><?php echo $BIZBOOK['SUBMIT']; ?> <?php } ?>
                            </button>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="exper-rev-box">
                        ...
                        ?>
                            ...
                            <form class="col" name="expert_review_form" id="expert_review_form" method="post">
                                <input type="hidden" class="form-control" name="expert_id" value="<?php echo $expert_profile_row['expert_id']; ?>">
                                <input type="hidden" class="form-control" name="expert_user_id" value="<?php echo $expert_profile_user_id; ?>">
                                <input name="review_user_id" value="<?php echo $session_user_id; ?>" type="hidden">
                                <div id="expert_review_success" style="text-align:center;display: none;color: green;">
                                    <?php echo $BIZBOOK['LISTING_DETAILS_REVIEW_SUCCESS_MESSAGE']; ?>
                                </div>
                                <div id="expert_review_fail" style="text-align:center;display: none;color: red;">
                                    <?php echo $BIZBOOK['OOPS_SOMETHING_WENT_WRONG']; ?></div>
                                ...
                                <div class="rating-new-msg">
                                    <textarea name="expert_message" placeholder="<?php echo $BIZBOOK['SERVICE-EXPERT-REVIEW-WRITE-YOUR-COMMENTS-LABEL']; ?>"></textarea>
                                </div>
                                <div class="rating-new-cta">
                                    <span data-dismiss="modal">Not now</span>
                                    <button type="submit" name="expert_review_submit" id="expert_review_submit"><?php echo $BIZBOOK['SERVICE-EXPERT-REVIEW-SUBMIT-REVIEW']; ?></button>
                                </div>
                            </form>
                        <?php } ?>
                    </div>
...
<div class="msg-op msg-op-new">
    ...
    <div class="inn">
        <form name="new_chat_form" id="new_chat_form" method="post">
            ...
            <div class="s3">
                <input type="text" name="chat_message" id="chat_message" placeholder="<?php echo $BIZBOOK['DB-MESSAGES-PLACEHOLDER']; ?>" required="">
...
<script src="<?php echo $slash; ?>service-experts/js/expert_booking.js"></script>
