    ...
    <div class="container">
        <div class="row">
            ...
            <div class="login-main add-list">
                ...
                <div class="log">
                    <form action="service_expert_insert.php" class="service_expert_form" id="service_expert_form" name="service_expert_form" method="post" enctype="multipart/form-data">
                        <input type="hidden" id="cover_image_old" value="<?php echo $service_expert_row['cover_image']; ?>" name="cover_image_old" class="validate">
                        <input type="hidden" id="root_path" value="<?php echo $slash; ?>" name="root_path" class="validate">
                        <input type="hidden" id="profile_image_old" value="<?php echo $service_expert_row['profile_image']; ?>" name="profile_image_old" class="validate">
                        <input type="hidden" id="id_proof_old" value="<?php echo $service_expert_row['id_proof']; ?>" name="id_proof_old" class="validate">
                        <div class="inn">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="tit"><?php echo $BIZBOOK['NAME']; ?>*</label>
                                    <input type="text" name="profile_name" value="<?php echo $service_expert_row['profile_name'] != NULL ? $service_expert_row['profile_name'] : $user_details_row['first_name']; ?>" class="form-control" readonly="readonly">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="tit">Address</label>
                                    <input type="text" name="address" class="form-control" placeholder="Address" value="<?php echo $service_expert_row['address']; ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select onChange="getExpertSubCategory(this.value);" class="chosen-select" name="category_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" onkeypress="return isNumber(event)" name="years_of_experience" value="<?php echo $service_expert_row['years_of_experience']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="tit"><?php echo $BIZBOOK['SERVICE-EXPERT-BASE-FARE-LABEL']; ?></label>
                                    <input type="text" name="base_fare" onkeypress="return isNumber(event)" value="<?php echo $service_expert_row['base_fare']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="tit">Pincode</label>
                                    <input type="text" maxlength="4" pattern="\d{4}" name="pincode" required="required" id="pincode" value="<?php echo $service_expert_row['pincode']; ?>" placeholder="Pincode, Ex: 3003" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="tit"><?php echo $BIZBOOK['SERVICE-EXPERT-SERVICES-CAN-DO-LABEL']; ?></label>
                                    <select class="chosen-select" required="required" multiple="multiple" id="sub_category_id" name="sub_category_id[]">
                                        <?php
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="tit"><?php echo $BIZBOOK['SERVICE-EXPERT-SERVICES-AREAS-LABEL']; ?></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="tit"><?php echo $BIZBOOK['SERVICE-EXPERT-PAYMENT-ACCEPT-LABEL']; ?></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group jb-fm-box-hig">
                                    ...
                                    <div id="jb-expe" class="collapse coll-box">
                                        <input type="text" name="experience_1" value="<?php echo $service_expert_row['experience_1']; ?>" class="form-control">
                                        <hr>
                                        <input type="text" name="experience_2" value="<?php echo $service_expert_row['experience_2']; ?>" class="form-control">
                                        <hr>
                                        <input type="text" name="experience_3" value="<?php echo $service_expert_row['experience_3']; ?>" class="form-control">
                                        <hr>
                                        <input type="text" name="experience_4" value="<?php echo $service_expert_row['experience_4']; ?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group jb-fm-box-hig">
                                    ...
                                    <div id="jb-edu" class="collapse coll-box">
                                        <input type="text" name="education_1" value="<?php echo $service_expert_row['education_1']; ?>" class="form-control">
                                        <hr>
                                        <input type="text" name="education_2" value="<?php echo $service_expert_row['education_2']; ?>" class="form-control">
                                        <hr>
                                        <input type="text" name="education_3" value="<?php echo $service_expert_row['education_3']; ?>" class="form-control">
                                        <hr>
                                        <input type="text" name="education_4" value="<?php echo $service_expert_row['education_4']; ?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group jb-fm-box-hig">
                                    ...
                                    <div id="jb-addi" class="collapse coll-box">
                                        <input type="text" name="additional_info_1" value="<?php echo $service_expert_row['additional_info_1']; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['JOB_EXTRA_COURSES']; ?>">
                                        <hr>
                                        <input type="text" name="additional_info_2" value="<?php echo $service_expert_row['additional_info_2']; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['JOB_TRAINING_DETAILS']; ?>">
                                        <hr>
                                        <input type="text" name="additional_info_3" value="<?php echo $service_expert_row['additional_info_3']; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['JOB_OTHERS_1']; ?>">
                                        <hr>
                                        <input type="text" name="additional_info_4" value="<?php echo $service_expert_row['additional_info_4']; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['JOB_OTHERS_2']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6 serex-date">
                                <label class="tit"><?php echo $BIZBOOK['SERVICE-EXPERT-DATE-OF-BIRTH-LABEL']; ?></label>
                                <input type="text" name="date_of_birth" value="<?php echo $service_expert_row['date_of_birth']; ?>" class="form-control" id="dobfield">
                            </div>
