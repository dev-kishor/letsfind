...
if (isset($_GET['category'])) {
    ...
    $cat_search_row = getSlugJobCategoryLike($category_search_slug);  //Fetch Category Id using category name
    ...
    $category_search_query = "AND (category_id in ($category_id) or job_title like '%$category_search_slug%' 
                                                                or job_role like '%$category_search_slug%' 
                                                                or job_description like '%$category_search_slug%' 
                                                                or job_small_description like '%$category_search_slug%'
                                                                or job_company_name like '%$category_search_slug%')
    ";
}
                ...
                <div class="col-md-3 fil-mob-view">
                    ...
                    <div class="filt-com lhs-cate">
                        ...
                        <div class="form-group">
                            <select onChange="jobSubcategoryFilter(this.value);" name="cat_check" id="cat_check" class="cat_check chosen-select ">
                    ...
                    <div class="sub_cat_section filt-com lhs-sub">
                        ...
                        <ul>
                            ...
                            foreach ($sub_category_qry as $sub_category_row) { ?>
                                <li>
                                    <div class="chbox">
                                        <input type="checkbox" class="sub_cat_check" name="sub_cat_check" value="<?php echo $sub_category_row['sub_category_id']; ?>" <?php
                                    ...
                                    <li>
                                        <div class="job-box">
                                            <div class="job-box-img">
                                                <img src="<?php echo $slash; ?>jobs/images/jobs/<?php echo $jobrow['company_logo']; ?>" alt="">
                                            </div>
                                            <div class="job-days">
