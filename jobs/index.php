                                ...
                                <div class="inn">
                                    <div class="jbtre-img">
                                        <div class="jbtre-img1">
                                            <img loading="lazy" src="<?php echo $slash; ?>jobs/images/jobs/<?php echo $job_profile_row['company_logo']; ?>"
                                                 alt="">
                                        </div>
                            ...
                            <li>
                                <div class="job-box">
                                    <div class="job-box-img">
                                        <img loading="lazy" src="<?php echo $slash; ?>jobs/images/jobs/<?php echo $job_sql_row['company_logo']; ?>" alt="">
                                    </div>
                                    <div class="job-days">
                ...
                <div class="filt-com lhs-ads">
                    <div class="ads-box">
                        ...
                        <a href="<?php echo stripslashes($get_ad_row['ad_link']); ?>">
                            ...
                            <img loading="lazy" src="<?php echo $slash; ?>images/ads/<?php if ($ad_enquiry_photo != NULL || !empty($ad_enquiry_photo)) {
