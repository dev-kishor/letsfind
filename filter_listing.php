                        ...
                        <div class="list-con">
                            <h4>
                                ...
                                <?php if ($listrow['user_plan'] == 4 || $listrow['user_plan'] == 3 || $listrow['user_plan'] == 2) { ?>
                                    <i class="li-veri"><img loading="lazy" src="<?php echo $webpage_full_link; ?>images/icon/svg/verified.png"></i>
                                <?php } ?>
                            </h4>
                        ...
                        <!---SAVE--->
                                    <span class="enq-sav" data-toggle="tooltip"
                                        ...
                                        <i class="l-like Animatedheartfunc<?php echo $listing_id ?> <?php echo $active_listing_likes; ?>"
                                           ...
                                           data-id='<?php echo $listing_id ?>'><img loading="lazy" src="<?php echo $webpage_full_link; ?>images/icon/svg/like.svg"></i></span>
                        <!---END SAVE--->
                    </div>
                </li>
