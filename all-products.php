                        ...
                        <div class="filt-com sub_cat_section pro-fil-sub">
                            ...
                            <ul>
                                ...
                                foreach ($sub_category_qry as $sub_category_row) { ?>
                                    <li>
                                        <div class="chbox">
                                            <input type="checkbox" class="sub_cat_check" name="sub_cat_check" value="<?php echo $sub_category_row['sub_category_id']; ?>" id="<?php echo $sub_category_row['sub_category_name']; ?>" />
                            ...
                            <ul>
                                <li>
                                    <div class="chbox">
                                        ...
                                        <label for="price_check5"><?php echo $BIZBOOK['ABOVE']; ?> <?php echo $footer_row['currency_symbol']; ?>1000</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="chbox">
                                        <input type="checkbox" name="price_check" value="1000" class="price_check" id="price_check4" />
                                        <label for="price_check4"><?php echo $footer_row['currency_symbol']; ?>501 - <?php echo $footer_row['currency_symbol']; ?>1000</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="chbox">
                                        <input type="checkbox" name="price_check" value="500" class="price_check" id="price_check3" />
                                        <label for="price_check3"><?php echo $footer_row['currency_symbol']; ?>251 - <?php echo $footer_row['currency_symbol']; ?>500</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="chbox">
                                        <input type="checkbox" name="price_check" value="250" class="price_check" id="price_check2" />
                                        <label for="price_check2"><?php echo $footer_row['currency_symbol']; ?>101 - <?php echo $footer_row['currency_symbol']; ?>250</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="chbox">
                                        <input type="checkbox" name="price_check" value="100" class="price_check" id="price_check1" />
                                        <label for="price_check1"><?php echo $BIZBOOK['BELOW']; ?> <?php echo $footer_row['currency_symbol']; ?>100</label>
                                    </div>
                                </li>
                            ...
                            <ul>
                                <li>
                                    <div class="chbox">
                                        ...
                                        <label for="discount_check5"><?php echo $BIZBOOK['ABOVE']; ?> 70%</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="chbox">
                                ...
                                <li>
                                    <div class="chbox">
                                        ...
                                        <label for="discount_check1"><?php echo $BIZBOOK['BELOW']; ?> 10%</label>
                                    </div>
                                </li>
