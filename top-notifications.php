...
<div class="top-noti">
    ...
    ?>
    <span class="material-icons db-menu-noti"><i id="noti-count"><?php echo AddingZero_BeforeNumber($total_notification_count); ?></i>notifications</span>
    <div class="db-noti top-noti-win">
        ...
        <ul id="all-notif-ul">
            ...
            if ($all_listing_notification_count > 0) {
                foreach (getAllUserListingDateEnquiries($session_user_id, $user_last_clear_notification) as $listing_enquiry_notificationrow) {
                    // pr($listing_enquiry_notificationrow);
            ...
            ?>
                        <li>
                            <div>
                                <?php
                                if ($listing_enquiry_notificationrow["enquiry_sender_id"] == "88888") {
                                ?>
                                    <a target="_blank" href="<?php echo $webpage_full_link . "db-enquiry"; ?>"><?php echo $listing_enquiry_notificationrow['enquiry_name']; ?></a>(visitor) <?php echo $BIZBOOK['DB-NOTIFICATION-SEND-LISTING-ENQUIRY']; ?>
            ...
            ?>
                        <li>
                            <div>
                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($enquiry_user['user_slug']); ?>"><?php echo $enquiry_user['first_name']; ?></a><?php echo $BIZBOOK['DB-NOTIFICATION-SEND-EVENT-ENQUIRY']; ?>
            ...
            ?>
                        <li>
                            <div>
                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($enquiry_user['user_slug']); ?>"><?php echo $enquiry_user['first_name']; ?></a><?php echo $BIZBOOK['DB-NOTIFICATION-SEND-BLOG-ENQUIRY']; ?>
            ...
            ?>
                        <li>
                            <div>
                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($enquiry_user['user_slug']); ?>"><?php echo $enquiry_user['first_name']; ?></a><?php echo $BIZBOOK['DB-NOTIFICATION-SEND-PRODUCT-ENQUIRY']; ?>
            ...
            ?>
                        <li>
                            <div>
                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($enquiry_user['user_slug']); ?>"><?php echo $enquiry_user['first_name']; ?></a><?php echo $BIZBOOK['DB-NOTIFICATION-SEND-EXPERT-ENQUIRY']; ?>
            ...
            ?>
                        <li>
                            <div>
                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($enquiry_user['user_slug']); ?>"><?php echo $enquiry_user['first_name']; ?></a><?php echo $BIZBOOK['DB-NOTIFICATION-SEND-JOB-APPLIED']; ?>
            ...
            ?>
                        <li>
                            <div>
                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($enquiry_user['user_slug']); ?>"><?php echo $enquiry_user['first_name']; ?></a><?php echo $BIZBOOK['DB-NOTIFICATION-SEND-LISTING-LIKES']; ?>
                                <a href="<?php echo $LISTING_URL . urlModifier($enquiry_listing['listing_slug']); ?>"><?php echo $enquiry_listing['listing_name']; ?></a>.
                            </div>
            ...
            ?>
                        <li>
                            <div>
                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($enquiry_user['user_slug']); ?>"><?php echo $enquiry_user['first_name']; ?></a><?php echo $BIZBOOK['DB-NOTIFICATION-SEND-LISTING-REVIEW']; ?>
                                <a href="<?php echo $LISTING_URL . urlModifier($enquiry_listing['listing_slug']); ?>"><?php echo $enquiry_listing['listing_name']; ?></a>.
                            </div>
            ...
            ?>
                    <li>
                        <div>
                            <a target="_blank" href="<?php echo $notificationrow['notification_link']; ?>"><?php echo $notificationrow['notification_title']; ?></a>
        ...
        <span <?php if ($total_notification_count >= 1) {
                ?> style="display: none;" <?php } ?> id="no-noti-clr-noti" class="no-noti-clr-noti"><?php echo $BIZBOOK['NO-NOTIFICATIONS-TO-SHOW']; ?></span>
    </div>
</div>
