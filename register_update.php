    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['register_submit'])) {
            ...
            if ($user_type == "General") {
                ...
                $user_plan = '';
                $user_points = 0;
            } elseif ($user_type == "Service provider" || $user_type == "Service expert") {
            ...
            $qry = "INSERT INTO " . TBL . "users 
					(first_name, last_name, email_id, mobile_number, password, user_type, user_plan, register_mode, user_address, profile_image, user_points, user_facebook, user_twitter, user_youtube, user_website, user_slug, verification_code, verification_link,verification_status, user_status, user_clear_notification_cdt, user_cdt)
