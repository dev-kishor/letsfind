                ...
                <div class="rhs">
                    <div class="list-rhs-form pglist-bg pglist-p-com">
                        <div class="quote-pop">
                            ...
                            <div id="event_detail_enq_success" class="log new-tnk-msg" style="display: none;">
                                <p><?php echo $BIZBOOK['ENQUIRY_SUCCESSFUL_MESSAGE']; ?></p>
                            </div>
                            <div id="event_detail_enq_same" class="log" style="display: none;">
                                <p><?php echo $BIZBOOK['ENQUIRY_OWN_EVENT_MESSAGE']; ?></p>
                            </div>
                            ...
                            <form method="post" name="event_detail_enquiry_form" id="event_detail_enquiry_form">
                                <?php if (!isset($_SESSION['user_code']) && empty($_SESSION['user_code'])) { ?>
                                    ...
                                    <?php } ?>
                                    <input type="hidden" class="form-control" name="event_id" value="<?php echo $event_id ?>" placeholder="" required>
                                    <input type="hidden" class="form-control" name="listing_user_id" value="<?php echo $user_id; ?>" placeholder="" required>
                                    <input type="hidden" class="form-control" name="enquiry_sender_id" value="<?php echo $_SESSION['user_id']; ?>" placeholder="" required>
...
<section class="<?php if ($footer_row['admin_language'] == 2) {
    ...
    <div class="container">
        <div class="eve-deta-body-main">
            ...
            <div class="rhs">
                <div class="list-sh eventpassdiv">
                    <?php
                    $user_ID = $_SESSION['user_id'];
                    if (isset($user_ID)) {
                        $checkPass_sql = "SELECT count(*) as count from booked_event_pass where event_id = $event_id and user_id = $user_ID";
                ...
                <div class="sec-3">
                    <div class="pro-bad-sml">
                        <img src="<?php echo $slash; ?>images/user/<?php if (($event_user_row['profile_image'] == NULL) || empty($event_user_row['profile_image'])) {
                        ...
                        <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($event_user_row['user_slug']); ?>" class="fclick">&nbsp;</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <li>
                                <div class="eve-box">
                                    ...
                                    <div>
                                        ...
                                        <span class="addr"><?php echo $eventrow['event_address']; ?></span>
                ...
                <div class="modal-content">
                    ...
                    <div class="quote-pop">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="<?php echo $BIZBOOK['LEAD-MOBILE-PLACEHOLDER']; ?>" pattern="[7-9]{1}[0-9]{9}" title="<?php echo $BIZBOOK['LEAD-INVALID-MOBILE-TITLE']; ?>" required>
                            </div>
                            <div class="form-group">
