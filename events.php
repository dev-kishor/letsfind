...
if (isset($_GET['category'])) {
    ...
    $cat_search_row = getSlugEventCategoryLike($category_search_slug);  //Fetch Category Id using category name
    ...
    $category_search_query = "AND category_id in ($category_id) or event_name like '%$category_search_slug%' or event_description like '%$category_search_slug%'";
}
?>
<!-- START -->
    ...
    <div class="container">
        ...
        <!-- <div class="ban-search">
            <form>
                <ul>
                    <li class="sr-sea">
                        <input type="text" id="event-search" class="autocomplete" placeholder="<?php echo $BIZBOOK['EVENT_SEARCH_EVENT_PLACEHOLDER']; ?>">
                    </li>
                </ul>
            </form>
        </div> -->
