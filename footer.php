...
<section>
    <div class="cr">
        <div class="container">
            <div class="row">
                <p><?php echo $BIZBOOK['FOOTER-COPYRIGHT']; ?> © <?php echo $footer_row['copyright_year']; ?> <a href="<?php echo $footer_row['copyright_website_link']; ?>" target="_blank"><?php echo $footer_row['copyright_website']; ?></a>. <?php echo $BIZBOOK['FOOTER-PROUDLY-POWERED-BY']; ?> <a href="https://bizsym.com.au" target="_blank">Bizsym</a></p>
            </div>
        </div>
    </div>
</section>
...
<div class="fqui-menu">
    <ul>
        <li><a href="<?php echo $webpage_full_link; ?>"><img loading="lazy" src="<?php echo $slash; ?>images/icon/home.png"><?php echo $BIZBOOK['HOME']; ?></a></li>
        <li><span class="mob-sear"><img loading="lazy" src="<?php echo $slash; ?>images/icon/search1.png"><?php echo $BIZBOOK['SEARCH']; ?></span></li>
        <li><a href="<?php echo $webpage_full_link; ?>all-category" class="act"><img loading="lazy" src="<?php echo $slash; ?>images/icon/shop.png"><?php echo $BIZBOOK['SERVICES']; ?></a></li>
        <li><a href="<?php echo $webpage_full_link; ?>service-experts"><img loading="lazy" src="<?php echo $slash; ?>images/icon/expert.png"><?php echo $BIZBOOK['SERVICE-EXPERTS']; ?></a></li>
        <li><a href="<?php echo $webpage_full_link; ?>jobs"><img loading="lazy" src="<?php echo $slash; ?>jobs/images/icon/employee.png"><?php echo $BIZBOOK['JOBS']; ?></a></li>
        <li><a href="<?php echo $webpage_full_link; ?>events"><img loading="lazy" src="<?php echo $slash; ?>images/icon/calendar.png"><?php echo $BIZBOOK['EVENTS']; ?></a></li>
        <li><a href="<?php echo $webpage_full_link; ?>all-products"><img loading="lazy" src="<?php echo $slash; ?>images/icon/cart.png"><?php echo $BIZBOOK['PRODUCTS']; ?></a></li>
        <li><a href="<?php echo $webpage_full_link; ?>coupons"><img loading="lazy" src="<?php echo $slash; ?>images/icon/coupons.png"><?php echo $BIZBOOK['COUPONS']; ?></a></li>
        <li><a href="<?php echo $webpage_full_link; ?>blog-posts"><img loading="lazy" src="<?php echo $slash; ?>images/icon/blog1.png"><?php echo $BIZBOOK['BLOGS']; ?></a></li>
        <li><a href="<?php echo $webpage_full_link; ?>community"><img loading="lazy" src="<?php echo $slash; ?>images/icon/11.png"><?php echo $BIZBOOK['COMMUNITY']; ?></a></li>
