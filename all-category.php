                        ...
                        <ul id="tail-re">
                            <li>
                                <div class="sh-all-scat-box">
                                    ...
                                    <div class="rhs">
                                        <h4>
                                            <a href="<?php echo $ALL_LISTING_URL . urlModifier($category_sql_row['category_slug']); ?>"><?php echo $category_sql_row['category_name']; ?> </a><span>
                                                <?php
                                            ...
                                            ?>
                                                <li>
                                                    <a href="<?php echo $ALL_LISTING_URL . urlModifier($category_sql_row['category_slug']); ?>/<?php echo urlModifier($sub_category_sql_row['sub_category_slug']); ?>"><?php echo $sub_category_sql_row['sub_category_name']; ?>
                                                        <span><?php
                                                                if (getCountSubCategoryListing($sub_category_sql_row['sub_category_id']) === 0) {
                                                                    echo "";
                                                                } else {
                                                                    echo AddingZero_BeforeNumber(getCountSubCategoryListing($sub_category_sql_row['sub_category_id']));
                                                                }
                                                                ?></span></a>
                                                </li>
                                            <?php
