            ...
            <div class="login-main add-list">
                ...
                <div class="log">
                    <div class="login">
                        ...
                        <form action="add-listing-step-2.php" class="listing_form_1" id="listing_form_1" name="listing_form_1" method="post" enctype="multipart/form-data">
                            <!--FILED START-->
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input id="listing_name" name="listing_name" type="text" required="required" class="form-control" value="<?php echo $_SESSION['listing_name'] ?>" placeholder="<?php echo $BIZBOOK['LISTING_NAME_STAR']; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--FILED END-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="listing_mobile" class="form-control" value="<?php echo $_SESSION['listing_mobile'] ?>" placeholder="<?php echo $BIZBOOK['PHONE_NUMBER']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="listing_email" class="form-control" value="<?php echo $_SESSION['listing_email'] ?>" placeholder="<?php echo $BIZBOOK['EMAIL_ID']; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--FILED END-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="listing_whatsapp" class="form-control" value="<?php echo $_SESSION['listing_whatsapp'] ?>" placeholder="<?php echo $BIZBOOK['WHATSAPP_PLACEHOLDER']; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--FILED END-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="listing_website" class="form-control" value="<?php echo $_SESSION['listing_website'] ?>" placeholder="<?php echo $BIZBOOK['WEBSITE']; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--FILED END-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="listing_address" class="form-control" value="<?php echo $_SESSION['listing_address'] ?>" placeholder="<?php echo $BIZBOOK['SHOP_ADDRESS']; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--FILED START-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="listing_description" name="listing_description" placeholder="<?php echo $BIZBOOK['DETAILS_ABOUT_LISTING']; ?>"><?php echo $_SESSION['listing_description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <!--FILED END-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="fil-img-uplo">
                                            <span class="dumfil"><?php echo $BIZBOOK['UPLOAD_A_FILE'];  ?></span>
                                            <input type="file" name="cover_image" id="cover_image" accept="image/png,image/jpg,image/jpeg" class="form-control">
                                            <!-- <input type="file" name="cover_image" id="cover_image" accept="image/*,.jpg,.jpeg,.png" class="form-control"> -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="service_locations" name="service_locations" placeholder="<?php echo $BIZBOOK['ENTER_SERVICE_LOCATION']; ?>"><?php echo $_SESSION['service_locations']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <!--FILED END-->
