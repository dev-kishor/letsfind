        ...
        <div class="ud-lhs">
            ...
            <div class="ud-lhs-s2">
                <ul>
                        ...
                        <?php if ($footer_row['admin_product_show'] == 1 && $user_details_row['setting_product_show'] == 1) { ?>
                            <li>
                                <a href="<?php echo $slash; ?>db-products" class="<?php if ($current_page == "db-products.php") {
                                                                                        echo "db-lact";
                                                                                    } ?>"><img loading="lazy" src="<?php echo $slash; ?>images/icon/cart.png" alt="" /><?php echo $BIZBOOK['ALL_PRODUCTS']; ?></a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($footer_row['admin_listing_show'] == 1 && $user_details_row['setting_listing_show'] == 1) { ?>
                            <li>
                                ...
                                <a href="<?php echo $slash; ?>db-enquiry" class="<?php if ($current_page == "db-enquiry.php") {
                                                                                        echo "db-lact";
                                                                                    } ?>"><img loading="lazy" src="<?php echo $slash; ?>images/icon/tick.png" alt="" /><?php echo $BIZBOOK['LEAD_ENQUIRY']; ?></a>
                            </li>
                        <?php } ?>
                        <?php if ($footer_row['admin_expert_show'] == 1 && $user_details_row['setting_expert_show'] == 1) { ?>
                            <li>
                                <a href="<?php echo $slash; ?>service-experts/db-service-expert" class="<?php if ($current_page == "db-service-expert.php") {
                                                                                                            echo "db-lact";
                                                                                                        } ?>"><img src="<?php echo $slash; ?>images/icon/expert.png" alt="" /><?php echo $BIZBOOK['ALL_SERVICE_EXPERT_LEADS']; ?></a>
                            </li>
                        <?php } ?>
                        <li>
                    ...
                    <?php if (($user_details_row['user_type'] == "Service provider" || $user_details_row['user_type'] == "Service expert") && $footer_row['admin_expert_show'] == 1 && $user_details_row['setting_expert_show'] == 1) { ?>
                        <li>
                            <a href="<?php echo $slash; ?>service-experts/create-service-expert-profile" class="<?php if ($current_page == "create-service-expert-profile.php") {
                                                                                                                    echo "db-lact";
                                                                                                                } ?>"><img loading="lazy" src="<?php echo $slash; ?>images/icon/profile.png" alt="" /><?php echo $BIZBOOK['ADD_NEW_SERVICE_EXPERT']; ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($footer_row['admin_job_show'] == 1 && $user_details_row['setting_job_show'] == 1) { ?>
                        <li>
                            <a href="<?php echo $slash; ?>jobs/create-job-seeker-profile" class="<?php if ($current_page == "create-job-seeker-profile.php") {
                                                                                                        echo "db-lact";
                                                                                                    } ?>"><img loading="lazy" src="<?php echo $slash; ?>images/icon/profile.png" alt="" /><?php echo $BIZBOOK['PROFI_JOB_SEEKER_TIT']; ?></a>
                        </li>
                    <?php } ?>
                    <li>
                        <h4>My activities</h4>
                        <a href="<?php echo $slash; ?>jobs/db-user-applied-jobs"><img src="<?php echo $slash; ?>images/icon/job-apply.png" alt="" /><?php echo $BIZBOOK['ALL_APPLIED_JOBS']; ?></a>
                    </li>
                    <?php if ($footer_row['admin_expert_show'] == 1 && $user_details_row['setting_expert_show'] == 1) { ?>
                        <li>
                            <a href="<?php echo $slash; ?>service-experts/db-my-service-bookings" class="<?php if ($current_page == "db-my-service-bookings.php") {
                                                                                                                echo "db-lact";
                                                                                                            } ?>"><img src="<?php echo $slash; ?>images/icon/expert-book.png" alt="" /><?php echo $BIZBOOK['MY_SERVICE_BOOKINGS']; ?></a>
                        </li>
                    <?php } ?>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo $slash; ?>how-to" class="<?php if ($current_page == "how-to.php") {
                                                                            echo "db-lact";
                                                                        } ?>" target="_blank"><img loading="lazy" src="<?php echo $slash; ?>images/icon/dbl17.png" alt="" /><?php echo $BIZBOOK['HOW_TOS']; ?></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo $slash; ?>logout"><img loading="lazy" src="<?php echo $slash; ?>images/icon/dbl12.png" alt="" /><?php echo $BIZBOOK['LOG_OUT']; ?></a>
                    </li>
                </ul>
            </div>
        </div>