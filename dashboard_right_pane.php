    ...
    ?>
        ...
        <div class="ud-rhs-poin">
            ...
            <div class="ud-rhs-poin2">
                ...
                <p><?php echo $BIZBOOK['EARN_MORE_CREDIT_POINTS_P_TAG']; ?> <a href="#"><?php echo $BIZBOOK['PROMOTE_MY_BUSINESS_CLICK_HERE']; ?></a> <?php echo $BIZBOOK['PROMOTE_MY_BUSINESS_FOR_DEMO']; ?>
                </p>
        ...
        <!-- <div class="ud-rhs-pay">
            <div class="ud-rhs-pay-inn">
                ...
                <ul>
                    ...
                    <li><span class="ud-stat-pay-btn"><b><?php echo $BIZBOOK['DASH_RIGHT_CHECKOUT_COST']; ?>
                                :</b> <?php if ($user_plan_type['plan_type_price'] == 0) {
                                            echo "FREE";
                                        } else {
                                            echo $footer_row['currency_symbol'] . '' . $user_plan_type['plan_type_price'];
                                        } ?></span></li>
                    <li><span class="ud-stat-pay-btn"><b><?php echo $BIZBOOK['DASH_RIGHT_PAYMENT_STATUS']; ?>:</b> <?php
                                                                                                                    if ($user_details_row['user_type'] == "Service provider") {
                ...
                if ($user_details_row['user_type'] == "Service provider") {
                    if ($user_plan_type['plan_type_id'] != 4) { ?>
                        <a href="<?php echo $webpage_full_link; ?>pricing-details" class="btn btn1"><?php echo $BIZBOOK['DASH_RIGHT_CHANGE_MY_PLAN']; ?></a>
                    <?php
                    }
                ...
                } else { ?> <a href="<?php echo $webpage_full_link; ?>pricing-details" class="btn btn1"><?php echo $BIZBOOK['DASH_RIGHT_CHANGE_MY_PLAN']; ?></a> <?php }
                                                                                                                                                                    ?>
            </div>
        </div> -->
    <?php
                        ...
                        ?>
                            <li>
                                ...
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="listing_open_close_switch custom-control-input" id="<?php echo $list_switch_row['listing_id']; ?>" <?php if ($list_switch_row['listing_open'] == 1) {
                                                                                                                                                                            echo "checked";
                                                                                                                                                                        } ?>>
                                    <label class="custom-control-label" for="<?php echo $list_switch_row['listing_id']; ?>" data-toggle="tooltip" title="<?php echo $BIZBOOK['LISTING_OPEN_CLOSE_TITLE_POPUP']; ?>">
                                        &nbsp;</label>
                                </div>
                            </li>
                        <?php
            ...
            <div class="ud-rhs-pay-inn">
                ...
                <ul>
                    <li>
                        ...
                        <span class="cout"><?php echo AddingZero_BeforeNumber(getLastWeekCountUserEnquiries($_SESSION['user_id'])); ?></span>
                        <span class="name"><?php echo $BIZBOOK['LEADS']; ?></span>
                    </li>
                    <li>
                        <span class="view"><?php echo $BIZBOOK['VIEWS']; ?></span>
                        <span class="cout"><?php echo AddingZero_BeforeNumber(last_week_all_listing_pageview_count($_SESSION['user_id'])); ?></span>
                        <span class="name"><?php echo $BIZBOOK['LISTING']; ?></span>
                    </li>
                    <li>
                        <span class="view"><?php echo $BIZBOOK['VIEWS']; ?></span>
                        <span class="cout"><?php echo AddingZero_BeforeNumber(last_week_all_event_pageview_count($_SESSION['user_id'])); ?></span>
                        <span class="name"><?php echo $BIZBOOK['EVENTS']; ?></span>
                    </li>
                    <li>
                        <span class="view"><?php echo $BIZBOOK['VIEWS']; ?></span>
                        <span class="cout"><?php echo AddingZero_BeforeNumber(last_week_all_blog_pageview_count($_SESSION['user_id'])); ?></span>
                        <span class="name"><?php echo $BIZBOOK['BLOGS']; ?></span>
                    </li>
                    <li>
                        <span class="view"><?php echo $BIZBOOK['VIEWS']; ?></span>
                        <span class="cout"><?php echo AddingZero_BeforeNumber(last_week_all_product_pageview_count($_SESSION['user_id'])); ?></span>
                        <span class="name"><?php echo $BIZBOOK['PRODUCTS']; ?></span>
                    </li>
                    <li>
                        <span class="cout"><?php echo AddingZero_BeforeNumber(last_week_all_messages_count($_SESSION['user_id'])); ?></span>
        ...
        <div class="list-mig-like">
            <div class="list-ri-peo-like">
                ...
                <ul>
                    ...
                    ?>
                        <li>
                            <a href="<?php echo $PROFILE_URL . urlModifier($user_followers_row['user_slug']); ?>" target="_blank">
    ...
    $('.listing_open_close_switch').click(function() {
        ...
        $.ajax({
            ...
            data: {
                idd: idd,
                value1: new1
            }, //--> send data of checked checkbox on other page
