        ...
        <div class="container">
            <div class="row">
                <div class="lhs">
                    ...
                    <div class="profile">
                        <div class="jpro-ban-bg-img">
                            ...
                            <p><?php echo $BIZBOOK['JOIN_ON']; ?>:
                                <b><?php echo dateFormatconverter($usersqlrow['user_cdt']) ?></b>
                            </p>
                            <img loading="lazy" src="<?php echo $slash;
                                                        if (($usersqlrow['cover_image'] == NULL) || empty($usersqlrow['cover_image'])) {
                                                            echo "images/home4.jpg";
                                                        } else { ?>images/user/<?php echo $usersqlrow['cover_image'];
                                                                            } ?>" alt="">
                        </div>
                        <div class="jpro-ban-tit">
                            ...
                            <div class="s3">
                                <a data-toggle="modal" data-target="#sendemail" class="cta fol" target="_blank">Message</a>
                                <span <?php
                                        if ($session_user_id == NULL || empty($session_user_id)) {
                                            echo "disabled";
                                        }
                                        ?> class="cta userfollow follow-content<?php echo $profile_user_id ?>" data-item="<?php echo $profile_user_id; ?>" data-num="<?php echo $session_user_id; ?>">
                    ...
                    <?php
                    if (
                        $usersqlrow['user_facebook'] != NULL || $usersqlrow['user_twitter'] != NULL
                    ...
                    ?>
                        <div class="jb-pro-bio">
                            ...
                            <ul class="pro-soci">
                                ...
                                ?>
                                    <li>
                                        <a target="_blank" href="<?php echo $usersqlrow['user_facebook']; ?>"><img src="<?php echo $slash; ?>images/social/3.png" alt=""></a>
                                    </li>
                                <?php
                                }
                                ...
                                ?>
                                    <li>
                                        <a target="_blank" href="<?php echo $usersqlrow['user_twitter']; ?>"><img src="<?php echo $slash; ?>images/social/2.png" alt=""></a>
                                    </li>
                                <?php
                                }
                                ...
                                ?>
                                    <li>
                                        <a target="_blank" href="<?php echo $usersqlrow['user_youtube']; ?>"><img src="<?php echo $slash; ?>images/social/5.png" alt=""></a>
                                    </li>
                                <?php
                                }
                                ...
                                ?>
                                    <li>
                                        <a target="_blank" href="<?php echo $usersqlrow['user_website']; ?>"><img src="<?php echo $slash; ?>images/social/1.png" alt=""></a>
                                    </li>
                                <?php
                                }
                                ?>
                            ...
                            <?php if ($footer_row['admin_listing_show'] == 1 && $user_details_row['setting_listing_show'] == 1) { ?>
                                <div class="jpro-bd-com">
                                    ...
                                    <ul>
                                        ...
                                        ?>
                                            <div class="log">
                                                <p><?php echo $BIZBOOK['NO_LISTINGS_TO_SHOW']; ?></p>
                                            </div>
                                            <?php } else {
                                                ...
                                                <li>
                                                    <div class="pro-listing-box">
                                                        <div>
                                                            ...
                                                            <a href="<?php echo $LISTING_URL . urlModifier($listrow['listing_slug']); ?>" class="fclick">&nbsp;</a>
                                                        </div>
                                                        <div>
                                                            <span data-toggle="modal" data-target="#quote"><?php echo $BIZBOOK['LEAD-GET-QUOTE']; ?></span>
                                                        </div>
                                                    </div>
                                                </li>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="quote-pop">
                                                                    ...
                                                                    <div id="profile_enq_success" class="log new-tnk-msg" style="display: none;">
                                                                    ...
                                                                    <form method="post" name="profile_enquiry_form" id="profile_enquiry_form">
                                                                        <input type="hidden" class="form-control" name="listing_id" value="<?php echo $listing_id ?>" placeholder="" required>
                                                                        <input type="hidden" class="form-control" name="listing_user_id" value="<?php echo $profile_user_id; ?>" placeholder="" required>
                            ...
                            <?php if ($footer_row['admin_blog_show'] == 1 && $user_details_row['setting_blog_show'] == 1) { ?>
                                <div class="jpro-bd-com">
                                    ...
                                    <ul>
                                        ...
                                        ?>
                                            <div class="log">
                                                <p><?php echo $BIZBOOK['NO_BLOGS_TO_SHOW']; ?></p>
                                            </div>
                                            <?php } else {
                            ...
                            <?php if ($footer_row['admin_event_show'] == 1 && $user_details_row['setting_event_show'] == 1) { ?>
                                <div class="jpro-bd-com">
                                    ...
                                    <ul>
                                        ...
                                        ?>
                                            <div class="log">
                                                <p><?php echo $BIZBOOK['NO_EVENTS_TO_SHOW']; ?></p>
                                            </div>
                                            <?php } else {
                        ...
                        <div class="jpro-bd-com">
                            ...
                            <div class="ud-rhs-sec-2">
                                <ul>
                                    ...
                                    ?>
                                        <div class="log">
                                            <p><?php echo $BIZBOOK['NO_FOLLOWERS_TO_SHOW']; ?></p>
                                        </div>
                                        <?php } else {
                                        ...
                                        ?>
                                            <li>
                                                <div class="pro-sm-box">
                                                    <img src="<?php echo $slash; ?>images/user/<?php if (($user_followers_row['profile_image'] == NULL) || empty($user_followers_row['profile_image'])) {
                                                                                                    echo $footer_row['user_default_image'];
                                                                                                } else {
                ...
                <div class="rhs">
                                    ...
                                    ?>
                                        <li>
                                            <div class="hot-page2-hom-pre-1">
                                                <img src="<?php echo $slash; ?>images/user/<?php if (($related_user_details_row['profile_image'] == NULL) || empty($related_user_details_row['profile_image'])) {
                                                                                                echo $footer_row['user_default_image'];
                                                                                            } else {
                    ...
                    <div class="job-rel-pro">
                        <div class="hot-page2-hom-pre pmenu-spri">
                            ...
                            <ul>
                                <li><a href="<?php echo $webpage_full_link; ?>all-category" class="act"><img src="<?php echo $slash; ?>images/icon/shop.png">
                                ...
                                <?php if ($footer_row['admin_expert_show'] == 1 && $user_details_row['setting_expert_show'] == 1) { ?>
                                    <li><a href="<?php echo $webpage_full_link; ?>service-experts" class="act"><img src="<?php echo $slash; ?>images/icon/expert.png">
                                            <div class="qui-acc-short">
                                ...
                                <?php } ?>
                                <?php if ($footer_row['admin_job_show'] == 1 && $user_details_row['setting_job_show'] == 1) { ?>
                                    <li><a href="<?php echo $webpage_full_link; ?>jobs" class="act"><img src="<?php echo $slash; ?>jobs/images/icon/employee.png">
                                            <div class="qui-acc-short">
                                ...
                                <?php } ?>
                                <?php if ($footer_row['admin_event_show'] == 1 && $user_details_row['setting_event_show'] == 1) { ?>
                                    <li><a href="<?php echo $webpage_full_link; ?>events"><img src="<?php echo $slash; ?>images/icon/calendar.png">
                                            <div class="qui-acc-short">
                                ...
                                <?php if ($footer_row['admin_product_show'] == 1 && $user_details_row['setting_product_show'] == 1) { ?>
                                    <li><a href="<?php echo $webpage_full_link; ?>all-products"><img src="<?php echo $slash; ?>images/icon/cart.png">
                                            <div class="qui-acc-short">
                                ...
                                <?php if ($footer_row['admin_coupon_show'] == 1 && $user_details_row['setting_coupon_show'] == 1) { ?>
                                    <li><a href="<?php echo $webpage_full_link; ?>coupons"><img src="<?php echo $slash; ?>images/icon/coupons.png">
                                            <div class="qui-acc-short">
                                ...
                                <?php } ?>
                                <?php if ($footer_row['admin_blog_show'] == 1 && $user_details_row['setting_blog_show'] == 1) { ?>
                                    <li><a href="<?php echo $webpage_full_link; ?>blog-posts"><img src="<?php echo $slash; ?>images/icon/blog1.png">
                                            <div class="qui-acc-short">
                                ...
                                <?php } ?>
                                <li><a href="<?php echo $webpage_full_link; ?>community"><img src="<?php echo $slash; ?>images/icon/11.png">
                                        <div class="qui-acc-short">
    ...
    <div class="pop-ups pop-quo">
        ...
        <div class="modal fade" id="sendemail">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="log-bor">&nbsp;</div>
                    <span class="udb-inst"><?php echo $BIZBOOK['SEND_MAIL_TITLE']; ?></span>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <!-- Modal Header -->
                    <div class="quote-pop">
                        <h4><?php echo $BIZBOOK['SEND_MAIL_TITLE']; ?></h4>
                        <div id="msg_success" class="log" style="display: none;">
                            <p><?php echo $BIZBOOK['MSG_SUCCESSFUL_MESSAGE']; ?></p>
                        </div>
                        <div id="msg_fail" class="log" style="display: none;">
                            <p><?php echo $BIZBOOK['OOPS_SOMETHING_WENT_WRONG']; ?></p>
                        </div>
                        <form method="post" name="send_msg_to_sender" class="send_msg_to_sender_form">
                            <input type="hidden" name="receiver" value="<?php echo $profile_user_id ?>" required>
                            <?php if ($session_user_id != NULL || !empty($session_user_id)) {;
                            ?>
                                <input type="hidden" name="sender" value="<?php echo $session_user_id ?>" required>
                                <input type="hidden" name="sender_name" value="<?php echo $user_details_row["first_name"]; ?>" required>
                                <input type="hidden" name="sender_mobile" value="<?php echo  $user_details_row["mobile_number"]; ?>" required>
                                <input type="hidden" name="sender_email" value="<?php echo $user_details_row["email_id"] ?>" required>
                            <?php } else { ?>
                                <div class="form-group">
                                    <input type="text" name="sender_name" value="" class="form-control" placeholder="<?php echo $BIZBOOK['LEAD-NAME-PLACEHOLDER']; ?>" required="required">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="sender_mobile" value="" class="form-control" placeholder="<?php echo $BIZBOOK['LEAD-MOBILE-PLACEHOLDER']; ?>" pattern="[7-9]{1}[0-9]{9}" title="<?php echo $BIZBOOK['LEAD-INVALID-MOBILE-TITLE']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="<?php echo $BIZBOOK['ENTER_EMAIL_STAR']; ?>" value="" name="sender_email" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" title="<?php echo $BIZBOOK['LEAD-INVALID-EMAIL-TITLE']; ?>" required>
                                </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="<?php echo $BIZBOOK['SEND_MAIL_SUBJECT']; ?>" value="" name="subject" required>
                            </div>

                            <div class="form-group">
                                <textarea class="form-control" rows="3" name="message" placeholder="<?php echo $BIZBOOK['LEAD-MESSAGE-PLACEHOLDER']; ?>" required title="<?php echo $BIZBOOK['LEAD-INVALID-EMAIL-TITLE']; ?>"></textarea>
                            </div>
                            <input type="hidden" id="source">
                            <button type="submit" id="send_msg_to_sender_submit" name="msg_submit" class="send_msg_to_sender_submit btn btn-primary"><?php echo $BIZBOOK['SUBMIT']; ?></button>
                        </form>
                    </div>
                </div>
            </div>
