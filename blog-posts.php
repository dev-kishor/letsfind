...
if (isset($_GET['category'])) {
    ...
    $cat_search_row = getSlugBlogCategoryLike($category_search_slug);  //Fetch Category Id using category name
    ...
    $category_search_query = "AND category_id in ($category_id) or blog_name like '%$category_search_slug%' or blog_description like '%$category_search_slug%'";
}
?>
<!-- START -->
                        ...
                        <li>
                            <div class="blog-sli-box">
                                ...
                                <div class="rhs">
                                    ...
                                    <div class="auth">
                                        <img loading="lazy" src="<?php echo $slash; ?>images/user/<?php if (($top_user_details_row['profile_image'] == NULL) || empty($top_user_details_row['profile_image'])) {
                                ...
                                <a href="<?php echo $BLOG_URL . urlModifier($top_blog_row['blog_slug']); ?>" class="fclick"></a>
                            </div>
                        </li>
                    <?php
                    }
