    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                ?>
                <form action="update_expert_profile.php" class="expert_profile_form" id="expert_profile_form" name="expert_profile_form" method="post" enctype="multipart/form-data">
                    <input type="hidden" id="cover_image_old" value="<?php echo $service_expert_row['cover_image']; ?>" name="cover_image_old" class="validate">
                    <input type="hidden" id="expert_id" value="<?php echo $service_expert_row['expert_id']; ?>" name="expert_id" class="validate">
                        ...
                        <div class="col-md-12">
                            <div class="form-group jb-fm-box-hig">
                                ...
                                <div id="jb-addi" class="collapse coll-box">
                                    <input type="text" name="additional_info_1" value="<?php echo $service_expert_row['additional_info_1']; ?>" class="form-control" placeholder="<?php echo "Extra courses"; ?>">
                                    <hr>
                                    <input type="text" name="additional_info_2" value="<?php echo $service_expert_row['additional_info_2']; ?>" class="form-control" placeholder="<?php echo "Training details"; ?>">
                                    <hr>
                                    <input type="text" name="additional_info_3" value="<?php echo $service_expert_row['additional_info_3']; ?>" class="form-control" placeholder="<?php echo "Others 1"; ?>">
                                    <hr>
                                    <input type="text" name="additional_info_4" value="<?php echo $service_expert_row['additional_info_4']; ?>" class="form-control" placeholder="<?php echo "Others 2"; ?>">
                                </div>
                            </div>
                        </div>
