                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" maxlength="4" pattern="\d{4}" name="event_pincode" required="required" placeholder="Pincode, Ex: 3003" class="form-control" id="pincode" value="<?php echo $place_row['place_pincode']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--FILED END-->
