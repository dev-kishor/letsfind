    ...
    <section>
        <div class="ad-head">
            <div class="head-s1">
                ...
                <div class="logo">
                    <img <?php if ($footer_row['header_logo_width'] != NULL || $footer_row['header_logo_height'] != NULL) { ?>style="<?php if ($footer_row['header_logo_width'] != NULL) { ?>width: <?php echo $footer_row['header_logo_width']; ?>; <?php }
                                                                                                                                                                                                                                                    if ($footer_row['header_logo_height'] != NULL) { ?>height: <?php echo $footer_row['header_logo_height']; ?>;<?php } ?>" <?php } ?> src="../images/home/<?php echo $footer_row['header_logo']; ?>">
                </div>
            </div>
            <div class="head-s2">
                <div class="head-sear">
            ...
            <div class="head-s3">
                <div class="head-pro">
                    ...
                    ?>
                    <img src="../images/user/<?php if (($admin_row['admin_photo'] == NULL) || empty($admin_row['admin_photo'])) {
        ...
        <div class="ad-menu-lhs mshow">
            <div class="ad-menu">
                <ul>
                    ...
                    <?php } ?>
                    <li class="ic-sear">
                        <a href="#" class="<?php if ($current_page == 'search-lists.php' || $current_page == 'search-positions.php' || $current_page == 'search-lists-add.php') {
                                                echo 'mact';
                                            } ?>">Search Settings</a>
                        <div>
                            <h4>
                    ...
                    if ($footer_row['admin_listing_show'] == 1) {
                        if ($admin_row['admin_listing_options'] == 1) { ?>
                            ...
                            <li class="ic-li">
                                <a href="#" class="<?php if ($current_page == 'admin-all-listings.php' || $current_page == 'admin-add-new-listings.php' || $current_page == 'admin-create-duplicate-listing.php' || $current_page == 'admin-trash-listing.php' || $current_page == 'admin-claim-listing.php') {
                                                        echo 'mact';
                                                    } ?>">listings</a>
                                <div>
                                    <ol>
                        ...
                        if ($admin_row['admin_category_options'] == 1) { ?>
                            <li class="ic-cat">
                                <a href="#" class="<?php if ($current_page == 'admin-all-category.php' || $current_page == 'admin-add-new-category.php' || $current_page == 'admin-all-sub-category.php' || $current_page == 'admin-add-new-sub-category.php' || $current_page == 'admin-change-position-listing-category.php') {
                                                        echo 'mact';
                                                    } ?>">Listing Category</a>
                                <div>
                                    <ol>
                        ...
                        if ($admin_row['admin_city_options'] == 1) { ?>
                            <li class="ic-cit">
                                ...
                                <div>
                                    <ol>
                                        <li>
                                            <a href="admin-all-state.php">All States</a>
                                        </li>
                                        <li>
                                            <a href="admin-add-state.php">Add New State</a>
                                        </li>
                                    </ol>
                                </div>
                            </li>
                    ...
                    if ($footer_row['admin_expert_show'] == 1) {
                        if ($admin_row['admin_service_expert_options'] == 1) { ?>
                            ...
                            <li class="ic-eve">
                                <a href="#" class="<?php if ($current_page == 'expert-users.php' || $current_page == 'expert-new-create.php' || $current_page == 'expert-leads.php' || $current_page == 'expert-general-leads.php' || $current_page == 'expert-admin-info.php') {
                                                        echo 'mact';
                                                    } ?>">Service Experts</a>
                                <div>
                                    <ol>
                            ...
                            <li class="ic-cat">
                                <a href="#" class="<?php if ($current_page == 'expert-all-category.php' || $current_page == 'expert-add-new-category.php' || $current_page == 'expert-all-sub-category.php' || $current_page == 'expert-add-new-sub-category.php' || $current_page == 'expert-home-category-change.php') {
                                                        echo 'mact';
                                                    } ?>">Experts Category</a>
                                <div>
                                    <ol>
                            ...
                            <li class="ic-cit">
                                <a href="#" class="<?php if ($current_page == 'expert-all-city.php' || $current_page == 'expert-add-new-city.php' || $current_page == 'expert-edit-city.php' || $current_page == 'expert-delete-city.php' || $current_page == 'expert-all-area.php' || $current_page == 'expert-add-new-area.php' || $current_page == 'expert-edit-area.php' || $current_page == 'expert-delete-area.php') {
                                                        echo 'mact';
                            ...
                            <li class="ic-pay-acc">
                                <a href="#" class="<?php if ($current_page == 'expert-payment-accept.php' || $current_page == 'expert-add-new-payment.php' || $current_page == 'expert-delete-payment.php' || $current_page == 'expert-edit-payment.php') {
                                                        echo 'mact';
                    ...
                    if ($footer_row['admin_job_show'] == 1) {
                        if ($admin_row['admin_jobs_options'] == 1) { ?>
                            ...
                            <li class="ic-eve">
                                <a href="#" class="<?php if ($current_page == 'job-all.php' || $current_page == 'job-applicant-profiles.php' || $current_page == 'job-seeker-details.php' || $current_page == 'job-create.php' || $current_page == 'job-all-applied.php' || $current_page == 'jobs-premium.php' || $current_page == 'jobs-premium-edit.php') {
                                                        echo 'mact';
                                                    } ?>">Jobs</a>
                                <div>
                                    <ol>
                            ...
                            <li class="ic-cat">
                                <a href="#" class="<?php if ($current_page == 'admin-all-job-category.php' || $current_page == 'admin-add-new-job-category.php' || $current_page == 'admin-all-job-sub-category.php' || $current_page == 'admin-add-new-job-sub-category.php') {
                                                        echo 'mact';
                                                    } ?>">Job Category</a>
                                <div>
                                    <ol>
                            ...
                            <li class="ic-cat">
                                <a href="#" class="<?php if ($current_page == 'admin-all-job-skill-set.php' || $current_page == 'admin-add-new-job-skill-set.php') {
                                                        echo 'mact';
                                                    } ?>">Job Skill Set</a>
                                <div>
                                    <ol>
                    ...
                    if ($footer_row['admin_product_show'] == 1) {
                        ...
                        if ($admin_row['admin_product_category_options'] == 1) { ?>
                            <li class="ic-cat">
                                <a href="#" class="<?php if ($current_page == 'admin-all-product-category.php' || $current_page == 'admin-add-new-product-category.php' || $current_page == 'admin-all-product-sub-category.php' || $current_page == 'admin-add-new-product-sub-category.php') {
                                                        echo 'mact';
                                                    } ?>">Product Category</a>
                                <div>
                                    <ol>
                    ...
                    if ($footer_row['admin_blog_show'] == 1) {
                        if ($admin_row['admin_blog_options'] == 1) { ?>
                            ...
                            <li class="ic-cat">
                                <a href="#" class="<?php if ($current_page == 'admin-all-blog-category.php' || $current_page == 'admin-add-new-blog-category.php') {
                                                        echo 'mact';
                                                    } ?>">Blog Category</a>
                                <div>
                                    <ol>
                    ...
                    if ($footer_row['admin_news_show'] == 1) {
                        if ($admin_row['admin_news_options'] == 1) { ?>
                            ...
                            <li class="ic-news">
                                <a href="#" class="<?php if ($current_page == 'admin-all-news-city.php' || $current_page == 'admin-add-news-city.php') {
                                                        echo 'mact';
                                                    } ?>">News City</a>
                                <div>
                                    <ol>
                    ...
                    if ($footer_row['admin_place_show'] == 1) {
                        if ($admin_row['admin_news_options'] == 1) { ?>
                            ...
                            <li class="ic-cat">
                                <a href="#" class="<?php if ($current_page == 'place-all-category.php' || $current_page == 'place-add-new-category.php' || $current_page == 'place-category-position.php') {
                                                        echo 'mact';
                                                    } ?>">Category</a>
                                <div>
                                    <ol>
                    ...
                    if ($admin_row['admin_invoice_options'] == 1) { ?>
                        <li class="ic-inv">
                            <a href="#" class="<?php if ($current_page == 'admin-invoice-create.php' || $current_page == 'admin-send-invoice.php' || $current_page == 'admin-invoice-shared.php') {
                                                    echo 'mact';
                                                } ?>">Invoice</a>
                            <div>
                                <ol>
                    ...
                    if ($admin_row['admin_ads_options'] == 1) { ?>
                        ...
                        <li class="ic-ads">
                            <a href="#" class="<?php if ($current_page == 'admin-current-ads.php' || $current_page == 'admin-create-ads.php' || $current_page == 'admin-ads-request.php' || $current_page == 'admin-ads-price.php' || $current_page == 'admin-ads-google-integration.php' || $current_page == 'admin-ads-history.php' || $current_page == 'seo-google-adsense.php') {
                                                    echo 'mact';
                                                } ?>">Ads</a>
                            <div>
                                <ol>
                    ...
                    <li class="ic-slid">
                        <a href="#" class="<?php if ($current_page == 'admin-slider-all.php' || $current_page == 'admin-slider-create.php' || $current_page == 'admin-slider-edit.php' || $current_page == 'admin-slider-delete.php') {
                                                echo 'mact';
                                            } ?>">Slider Images</a>
                        <div>
                            <ol>
                    ...
                    if ($admin_row['admin_footer_options'] == 1) { ?>
                        <li class="ic-sub">
                            <a href="#" class="<?php if ($current_page == 'admin-footer.php' || $current_page == 'admin-footer-popular-tags.php') {
                                                    echo 'mact';
                                                } ?>">Footer</a>
                            <div>
                                <ol>
                    ...
                    if ($admin_row['admin_mail_template_options'] == 1) { ?>
                        <li class="ic-mail">
                            <a href="admin-all-mail.php" class="<?php if ($current_page == 'admin-all-mail.php' || $current_page == 'admin-mail-view.php') {
                                                                    echo 'mact';
                                                                } ?>">Mail Templates</a>
                        </li>
                    <?php }
                    ...
                    if ($admin_row['admin_sub_admin_options'] == 1) { ?>
                        <li class="ic-sub">
                            <a href="#" class="<?php if ($current_page == 'admin-sub-admin-all.php' || $current_page == 'admin-sub-admin-create.php' || $current_page == 'admin-sub-admin-log.php') {
                                                    echo 'mact';
                                                } ?>">Sub Admin</a>
                            <div>
                                <ol>
                    ...
                    <?php } ?>
                    <li class="ic-set">
                        <a href="admin-security-updates.php" class="<?php if ($current_page == 'admin-security-updates.php') {
                                                                        echo 'mact';
