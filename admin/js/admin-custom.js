$(document).ready(function () {
  ...
  $(".lis-add-off").click(function () {
    $(".add-list-off ul li:last-child").after(
  ...
  $(".cate-add-btn").click(function () {
    $(".add-ncate ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" id="category_name" name="category_name[]" class="form-control" placeholder="Category name *" required> </div> </div><div class="col-md-12"><div class="form-group"><label>Choose category image</label><input type="file" name="category_image[]" id="category_image" class="form-control" required></div></div></div></li>'
    );
  });
  //Job CATEGORY ADD - APPEND
  $(".job-cate-add-btn").click(function () {
    $(".add-ncate ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" id="category_name" name="category_name[]" class="form-control" placeholder="Category name *" required> </div> </div></div></li>'
    );
  });
  //Expert Paymemt ADD - APPEND
  $(".expert-paymente-add-btn").click(function () {
    $(".add-ncate ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" id="payment_name" name="payment_name[]" class="form-control" placeholder="Payment name *" required> </div> </div></div></li>'
    );
  });
  ...
  $(".count-add-btn").click(function () {
    $(".add-ncate ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" class="form-control" name="country_name[]" placeholder="Country name *" required> </div> </div> </div> </li>'
    );
  });
  ...
  $(".expert-city-add-btn").click(function () {
    $(".add-ncate ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" class="form-control" name="country_name[]" placeholder="City name *" required> </div> </div> </div> </li>'
    );
  });
  ...
  $(".expert-area-add-btn").click(function () {
    $(".add-ncate ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" class="form-control" name="city_name[]" placeholder="Area name *" required> </div> </div> </div> </li>'
    );
  });
  ...
  $(".scat-add-btn").click(function () {
    $(".add-ncate ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" class="form-control" placeholder="Sub category name *" name="sub_category_name[]" required> </div> </div> </div> </li>'
    );
  });
  ...
  $(".lis-add-oadvideo").on("click", function () {
    $(".add-list-map ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <textarea id="listing_video" name="listing_video[]" class="form-control" placeholder="Paste Your Youtube Url here"></textarea> </div> </div> </div> </li>'
    );
  });
  ...
  $(".prod-add-oad").on("click", function () {
    $(".add-prod-oth ul li:last-child").after(
  ...
  $(".prod-add-high-oad").on("click", function () {
    $(".add-prod-high-oth ul li:last-child").after(
      '<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" name="product_highlights[]" class="form-control" placeholder="Type your highlights"> </div> </div> </div> </li>'
    );
  });
  ...
  $(".plac-ask-add").on("click", function () {
    $(".whatask li:last-child").after(
      '<li> <div class="col-md-4"> <div class="form-group"> <label>Question:</label> <input type="text" name="place_info_question[]" required="required" class="form-control"> </div></div><div class="col-md-8"> <div class="form-group"> <label>Answer:</label> <input type="text" name="place_info_answer[]" required="required" class="form-control"> </div></div></li>'
    );
  });
  //PLACE - WHAT PEOPLE ASK REMOVE - APPEND
  $(".plac-ask-remov").on("click", function () {
    var _placque = $(".whatask li").length;
    if (_placque >= 2) {
      $(".whatask li:last-child").remove();
    } else {
      alert("Sorry! you are not allowed to remove the last one.");
    }
  });
  //PLACE - Things TODO - APPEND
  $(".plac-todo-add").on("click", function () {
    $(".thingstodo li:last-child").after(
      '<li><div class="col-md-4"><div class="form-group"><label>Name</label><input type="text" name="todo_name[]" class="form-control"/></div></div><div class="col-md-4"><div class="form-group"><label>URL</label><input type="text" name="todo_url[]" class="form-control"/></div></div><div class="col-md-4"><div class="form-group"><label>Image</label><input type="file" name="todo_img[]" class="form-control" onchange="filehandle(this)" accept="image/*,.jpg,.jpeg,.png"/></div></div></li>'
    );
  });
  //PLACE - Things TODO REMOVE - APPEND
  $(".plac-todo-remov").on("click", function () {
    var _placque = $(".thingstodo li").length;
    if (_placque >= 2) {
      $(".thingstodo li:last-child").remove();
    } else {
      alert("Sorry! you are not allowed to remove the last one.");
    }
  });
  ...
  $("#stdate, #endate, #adposi").change(function () {
    ...
    var diffDays = Math.abs(
      (startDay.getTime() - endDay.getTime()) / millisecondsPerDay
    );
      ...
      .filter(function () {
        return (
          $(this)
            .text()
            .toLowerCase()
            .indexOf($("#top_search").val().toLowerCase()) != -1
        );
      })
      .addClass("match")
      .show();
...
$("#thing_todo_image").on("change", function () {
  var fileInput = this;
  imageSizeAndFormateVaidation(fileInput, 20);
});
...
function imageSizeAndFormateVaidation(fileInput, allowMB) {
  let file_size = parseFloat(fileInput.files[0].size / (1024 * 1024)).toFixed(
    2
  );
...
$("#opening_time").on("change", function () {
  if (this.value == "247") {
    $("#closing_time_box").hide();
    $("#closing_time").prop("required", false);
  } else {
    $("#closing_time_box").show();
    $("#closing_time").prop("required", true);
  }
});
