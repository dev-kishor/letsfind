...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['listing_submit'])) {
        ...
        $listing_code = safe_input_Text($_POST["listing_code"]);
        ...
        $fb_link = safe_input_Text($_POST["fb_link"]);
        $gplus_link = safe_input_Text($_POST["gplus_link"]);
        $twitter_link = safe_input_Text($_POST["twitter_link"]);
