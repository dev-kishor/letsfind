            ...
            <div class="login-main add-list">
                ...
                <div class="log">
                    <div class="login add-list-off">
                        ...
                        <form action="blog_insert.php" class="blog_form" id="blog_form" name="blog_form" method="post"
                            ...
                            <ul>
                                <li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <select name="category_id" id="category_id"
                                                    class="chosen-select form-control" required="required">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea name="blog_description" id="blog_description" required
                                                    class="form-control"
