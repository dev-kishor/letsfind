...
<div class="ani-quo-form chatwindow">
    ...
    <div class="hom-col-req listchatbox">
        ...
        <form name="home_slide_enquiry_form" id="home_slide_enquiry_form" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" class="thread-list" value="<?php echo $listing_id ?>">
            <div class="form-group">
                <textarea class="form-control" rows="3" id="chattexttype" placeholder="type here..."></textarea>
            </div>
            <div class="sendbtn">
                <button type="button" class="btn btn-primary" id="sendmsgbtn">
        ...
        <div class="container">
            <div class="row">
                <div class="v3-list-ql-inn">
                    <ul>
                        <li class="active"><a href="#ld-abo"><i class="material-icons">person</i> <?php echo $BIZBOOK['LISTING_DETAILS_ABOUT']; ?>
                            </a>
                        </li>
                        <li><a href="#ld-ser"><i class="material-icons">business_center</i> <?php echo $BIZBOOK['LISTING_DETAILS_SERVICES']; ?>
                            </a>
                        </li>
                        <li><a href="#ld-gal"><i class="material-icons">photo</i> <?php echo $BIZBOOK['LISTING_DETAILS_GALLERY']; ?>
                            </a>
                        </li>
                        <li><a href="#ld-off"><i class="material-icons">style</i> <?php echo $BIZBOOK['LISTING_DETAILS_OFFERS']; ?>
                            </a>
                        </li>
                        <li><a href="#ld-360"><i class="material-icons">camera</i> <?php echo $BIZBOOK['LISTING_DETAILS_360_VIEW']; ?>
                            </a>
                        </li>
                        <li><a href="#ld-rev"><i class="material-icons">star_half</i> <?php echo $BIZBOOK['LISTING_DETAILS_WRITE_REVIEW']; ?>
                            </a>
                        </li>
                        <li><a href="#" data-toggle="modal" data-target="#claim"><i class="material-icons">store</i><?php echo $BIZBOOK['LISTING_DETAILS_CLAIM_BUSINESS']; ?>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="list-det-fix-inn">
                    ...
                    <div class="list-fix-btn">
                        <span data-toggle="modal" data-target="#quote" class="pulse"><?php echo $BIZBOOK['SEND_AN_ENQIRY']; ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="list-ban-btn">
                    <ul>
                        <li>
                            <a href="tel:<?php echo $listrow['listing_mobile']; ?>" class="cta cta-call"><?php echo $BIZBOOK['CALL_NOW']; ?></a>
                        </li>
                        <li><span class="cta cta-like ldelik Animatedheartfunc<?php echo $listing_id ?> <?php echo $check_listing_likes_active; ?>" data-for="<?php echo listing_total_like_count($listrow['listing_id']); ?>" data-section="<?php echo $check_listing_likes_total; ?>" data-num="<?php echo $list_user_id; ?>" data-item="<?php echo $session_user_id; ?>" data-id='<?php echo $listrow['listing_id'] ?>'>
                        ...
                        <?php if ($listrow['listing_whatsapp'] != NULL) { ?>
                            <li>
                                <a href="https://wa.me/<?php echo $listrow['listing_whatsapp']; ?>" class="cta cta-rev"><?php echo $BIZBOOK['WHATSAPP']; ?></a>
                            </li>
                        <?php } ?>
                        <li>
                        ...
                        <li>
                            ...
                            ?>
                                <a class="cta cta-chat chatbtnbox" href="<?php echo $webpage_full_link ?>login">Login to Chat</a>
                            <?php
                            } else {
                            ?>
            ...
            <div class="com-padd">
                <div id="ld-abo" class="list-pg-lt list-page-com-p">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            ?>
                                                <div class="carousel-item <?php if ($p == 1) {
                                                    ...
                                                    <img loading="lazy" src="<?php echo $slash; ?>images/listings/<?php echo $item; ?>" alt="<?php echo $item; ?>">
                                                </div>
                                                <?php
                                                $p++;
                                            }
                                ...
                                ?>
                                    <div class="list-pg-inn-sp">
                                        <div class="home-list-pop">
                                            <!--LISTINGS IMAGE-->
                                            <div class="col-md-3"><img src="<?php echo $slash; ?>images/services/<?php if ($tuple[3] != NULL) {
                                                                                                                        echo $tuple[3];
                                                                                                                    } else {
                                                                                                                        echo "5.jpg";
                                                                                                                    } ?>" alt=""></div>
                                            ...
                                            <div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"><a href="#!">
                                                    <h3><?php echo $tuple[0]; ?></h3>
                                                </a>
                                                <p><?php echo $tuple[2]; ?></p>
                                                <?php
                                                if (!empty($tuple[1])) {
                                                ?>
                                                    <span class="home-list-pop-rat list-rom-pric"><?php echo $footer_row['currency_symbol']; ?><?php echo $tuple[1]; ?></span>
                                                <?php
                                                }
                                                ?>
                                                <div class="list-enqu-btn">
                                                    <ul>
                                                        <li>
                                                            <a <?php if ($tuple[4] != NULL) { ?>target="_blank" <?php } ?> href="<?php if ($tuple[4] != NULL) {
                                                                                                                                        echo $tuple[4];
                                                                                                                                    } else { ?>#! <?php } ?>"><?php echo $BIZBOOK['VIEW_MORE']; ?></a>
                                                        </li>
                                                        <li><a href="#!" data-toggle="modal" data-target="#quote"><?php echo $BIZBOOK['LEAD-SEND-ENQUIRY']; ?></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            ?>
                                ...
                                ?>
                                    <span id="Review_Disable"><?php echo $BIZBOOK['LISTING_DETAILS_LOGIN_AND_WRITE_REVIEW']; ?></span>
                                <?php
                                }
                                ?>
                                    ...
                                    <div class="list-pg-inn-sp">
                                        <div class="list-pg-write-rev">
                                            <form class="col" <?php if ($session_plan_type_row['plan_type_ratings'] == 0 && $user_details_row['user_type'] != "General") {
                                                ...
                                                <input type="hidden" class="form-control" name="listing_id" value="<?php echo $listrow['listing_id']; ?>">
                                                <input type="hidden" class="form-control" name="listing_user_id" value="<?php echo $list_user_id; ?>">
                                                <input name="review_user_id" value="<?php echo $session_user_id; ?>" type="hidden">
                                                <p><?php echo $BIZBOOK['LISTING_DETAILS_REVIEW_P_TAG']; ?>:</p>
                                                <div id="review_success" style="text-align:center;display: none;color: green;"><?php echo $BIZBOOK['LISTING_DETAILS_REVIEW_SUCCESS_MESSAGE']; ?>
                                                </div>
                                                <div id="review_fail" style="text-align:center;display: none;color: red;"><?php echo $BIZBOOK['OOPS_SOMETHING_WENT_WRONG']; ?></div>
                                                <div class="row">
                                                    <div>
                                                ...
                                                <div class="row">
                                                    <div class="input-field col s6">
                                                        <input id="review_name" <?php if (!empty($_SESSION['user_name'])) {
                                                                                    echo "readonly";
                                                                                } ?> <?php if ($session_plan_type_row['plan_type_ratings'] == 0 && $user_details_row['user_type'] != "General") {
                                                                                            echo "disabled";
                                                                                        } ?> name="review_name" type="text" value="<?php if (!empty($_SESSION['user_name'])) {
                                                                                                                                        echo $user_details_row['first_name'];
                                                                                                                                    } ?>">
                                                    </div>
                                                    <div class="input-field col s6">
                                                        <input id="review_mobile" <?php if (!empty($_SESSION['user_name'])) {
                                                                                        echo "readonly";
                                                                                    } ?> <?php if ($session_plan_type_row['plan_type_ratings'] == 0 && $user_details_row['user_type'] != "General") {
                                                                                                echo "disabled";
                                                                                            } ?> name="review_mobile" type="text" onkeypress="return isNumber(event)" placeholder="Mobile number" value="<?php if (!empty($_SESSION['user_name'])) {
                                                ...
                                                <div class="row">
                                                    <div class="input-field col s6">
                                                        <input id="review_email" <?php if (!empty($_SESSION['user_name'])) {
                                                                                        echo "readonly";
                                                                                    } ?> <?php if ($session_plan_type_row['plan_type_ratings'] == 0 && $user_details_row['user_type'] != "General") {
                                                                                                echo "disabled";
                                                                                            } ?> name="review_email" type="email" placeholder="Email Id" value="<?php if (!empty($_SESSION['user_name'])) {
                                                    ...
                                                    <div class="input-field col s6">
                                                        <input id="review_city" <?php if ($session_plan_type_row['plan_type_ratings'] == 0 && $user_details_row['user_type'] != "General") {
                                                                                    echo "disabled";
                                                                                } ?> name="review_city" placeholder="City" type="text">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <textarea id="review_message" <?php if ($session_plan_type_row['plan_type_ratings'] == 0 && $user_details_row['user_type'] != "General") {
                                                                                            echo "disabled";
                                                                                        } ?> placeholder="Write review" name="review_message"></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <?php if ($session_plan_type_row['plan_type_ratings'] == 0 && $user_details_row['user_type'] != "General") { ?>
                                                            <input type="submit" id="" name="" disabled="disabled" readonly="readonly" value="<?php echo $BIZBOOK['LISTING_DETAILS_UNABLE_SUBMIT_REVIEW']; ?>">
                                                        <?php } else { ?>
                                                            <input type="submit" id="review_submit" name="review_submit" value="<?php echo $BIZBOOK['LISTING_DETAILS_SUBMIT_REVIEW']; ?>">
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            </form>
                    ...
                    ?>
                                    ...
                                    <div class="lp-ur-all">
                                        <div class="lp-ur-all-left">
                                            <div class="lp-ur-all-left-1">
                                                <div class="lp-ur-all-left-11"><?php echo $BIZBOOK['EXCELLENT']; ?></div>
                                            ...
                                            <div class="lp-ur-all-left-1">
                                                <div class="lp-ur-all-left-11"><?php echo $BIZBOOK['SATISFACTORY']; ?></div>
                                                <div class="lp-ur-all-left-12">
                                                    <div class="lp-ur-all-left-13 lp-ur-all-left-satis"></div>
                                                </div>
                                            </div>
                                            <div class="lp-ur-all-left-1">
                                                <div class="lp-ur-all-left-11"><?php echo $BIZBOOK['BELOW_AVERAGE']; ?></div>
                                                <div class="lp-ur-all-left-12">
                                            ...
                                            ?>
                                                <li>
                                                    ...
                                                    <div class="lr-user-wr-con">
                                                        ...
                                                        <span class="lr-revi-date"><?php echo dateFormatconverter($reviewsqlrow['review_cdt']); ?></span>
                        ...
                        ?>
                            <div class="spa-first-review"><?php echo $BIZBOOK['LISTING_DETAILS_BE_FIRST_REVIEW']; ?></div>
                        <?php
                        }
                        ?>
                                ...
                                <li>
                                    <div class="land-pack-grid">
                                        <div class="land-pack-grid-img">
                                            <img src="<?php if ($except_list_row['profile_image'] != NULL || !empty($except_list_row['profile_image'])) {
                                        ...
                                        <a target="_blank" href="<?php echo $LISTING_URL . urlModifier($except_list_row['listing_slug']); ?>" class="land-pack-grid-btn"></a>
                                    </div>
                                </li>
                            <?php
                            }
                            ...
                            <form method="post" name="detail_enquiry_form" id="detail_enquiry_form">
                                ...
                                <?php } else { ?>
                                    <button <?php if ($session_user_id == NULL || empty($session_user_id)) {
                                            ?> disabled="disabled" <?php } ?> type="submit" id="detail_enquiry_submit" name="enquiry_submit" class="btn btn-primary"><?php if ($session_user_id == NULL || empty($session_user_id)) {
                        ...
                        <div class="lide-guar pglist-bg pglist-p-com">
                            ...
                            <div class="list-pg-inn-sp">
                                <div class="list-pg-guar">
                                    <ul>
                                        <li>
                                            <div class="list-pg-guar-img"><img src="<?php echo $slash; ?>images/icon/g2.png" alt="" /></div>
                                            <h4><?php echo $BIZBOOK['LISTING_DETAILS_CLAIM_THIS_BUSINESS']; ?></h4>
                                            <span data-toggle="modal" data-target="#claim" class="clim-edit"><?php echo $BIZBOOK['LISTING_DETAILS_SUGGEST_AN_EDIT']; ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="list-mig-like">
                            <div class="list-ri-peo-like">
                                ...
                                <ul>
                                    ...
                                    ?>
                                        <li>
                                            <a href="<?php echo $webpage_full_link; ?>profile/<?php echo preg_replace('/\s+/', '-', strtolower($user_id_liked_row['user_slug'])); ?>" target="_blank">
                                                <img src="<?php echo $slash; ?>images/user/<?php if (($user_id_liked_row['profile_image'] == NULL) || empty($user_id_liked_row['profile_image'])) {
                                                                                                echo $footer_row['user_default_image'];
                                                                                            } else {
                    ...
                    <div class="quote-pop">
                        ...
                        <form method="post" name="popup_claim_form" id="popup_claim_form">
                            <fieldset <?php if ($list_user_id == $session_user_id || empty($session_user_id) || $session_user_id == Null) {
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="<?php echo $BIZBOOK['LEAD-EMAIL-PLACEHOLDER']; ?>" required="required" value="" name="enquiry_email" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" title="<?php echo $BIZBOOK['LEAD-INVALID-EMAIL-TITLE']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" rows="3" name="enquiry_message" placeholder="<?php echo $BIZBOOK['LEAD-WHY-CLAIM-BUSINESS-TITLE']; ?>"></textarea>
                                </div>
                                <input type="hidden" id="source">
                                <button type="submit" <?php if ($list_user_id == $session_user_id || empty($session_user_id) || $session_user_id == Null) {
                                                        ?> disabled="disabled" <?php } ?> id="popup_claim_submit" name="popup_claim_submit" class="btn btn-primary"><?php if (empty($session_user_id) || $session_user_id == Null) {
                        ...
                        <div class="form-notes">
                            <p><?php echo $BIZBOOK['LISTING_DETAILS_CLAIM_P_TAG']; ?></p>
                        </div>
                    </div>
                </div>
            </div>
