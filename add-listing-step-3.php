            ...
            <div class="login-main add-list">
                ...
                <div class="log">
                    <div class="login add-list-off">
                        ...
                        <form action="add-listing-step-4.php" class="listing_form_3" id="listing_form_3" name="listing_form_3" method="post" enctype="multipart/form-data">
                            <ul>
                                <?php
                                ...
                                ?>
                                        <li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="service_1_name[]" value="<?php echo $tuple[0]; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['OFFER_NAME']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="service_1_price[]" onkeypress="return isNumber(event)" value="<?php echo $tuple[1]; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['PRICE']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--FILED END-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <textarea name="service_1_detail[]" class="form-control" placeholder="<?php echo $BIZBOOK['DETAILS_ABOUT_OFFER']; ?>"><?php echo $tuple[2]; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--FILED END-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" name="service_1_view_more[]" value="<?php echo $tuple[3]; ?>" class="form-control" placeholder="<?php echo $BIZBOOK['VIEW_MORE_LINK']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--FILED END-->
                                    ...
                                    <li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" name="service_1_price[]" onkeypress="return isNumber(event)" class="form-control" placeholder="<?php echo $BIZBOOK['PRICE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!--FILED END-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea name="service_1_detail[]" class="form-control" placeholder="<?php echo $BIZBOOK['DETAILS_ABOUT_OFFER']; ?>"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!--FILED END-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="service_1_view_more[]" class="form-control" placeholder="<?php echo $BIZBOOK['VIEW_MORE_LINK']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!--FILED END-->
