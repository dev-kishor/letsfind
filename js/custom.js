$(document).ready(function () {
  ...
  $(".ca-check-plan").on("change", function () {
    if (
      $(this).val() == "Service provider" ||
      $(this).val() == "Service expert"
    ) {
  ...
  $(".servicecontainer").on("change", ".fil-img-uplo input", function () {
    var _upldfname = $(this)
      .val()
...
$(".enq-sav i").on("click", function () {
  ...
  if (user_id) {
    //Check Current User is Null Means redirect to login page
    if (listing_user_id == user_id) {
      //Check Listing Owner and Current User is Same
      // alert("same user");
    } else {
      // alert("other user");
...
$(".userfollow").on("click", function () {
  ...
  if (user_id) {
    ...
    if (sender_user_id == user_id) {
      //Check send User and Current User is Same
      // alert("same user");
    } else {
      // alert("other user");
      if (webpage_full_link != null) {
  ...
  $(function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        //     dataCountry[categoryArray[i]] = undefined; //categoryArray[i].flag or null
        // }
        $("#event-search.autocomplete").autocomplete({
          //Home Page City Search Box
          source: eventArray,
          limit: 10, // The max amount of results that can be shown at once. Default: Infinity.
  ...
  $(function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        //     dataCountry[categoryArray[i]] = undefined; //categoryArray[i].flag or null
        // }
        $("#blog-search.autocomplete").autocomplete({
          //Home Page City Search Box
          source: blogArray,
          limit: 10, // The max amount of results that can be shown at once. Default: Infinity.
...
jQuery(document).ready(function ($) {
  $("#filter_submit").on("click", function () {
    ...
    window.location.href =
      link +
      "search_box_process.php?explor_select=" +
      explor_select +
      "&expert_select_search=" +
      expert_select_search +
      "&select_city=" +
      select_city;
  });
...
$("#top-select-search").keypress(function (e) {
  ...
  if (key == 13) {
    ...
    window.location.href =
      link +
      "search_box_process.php?select_search=" +
      select_search +
      "&select_city=" +
      select_city;
    //return false;
...
jQuery(document).ready(function ($) {
  $("#job_filter_submit").on("click", function () {
    ...
    window.location.href =
      link +
      "jobs/job_search_box_process.php?select_search=" +
      select_search +
      "&select_city=" +
      select_city;
  });
...
jQuery(document).ready(function ($) {
  $("#expert_filter_submit").on("click", function () {
    ...
    window.location.href =
      link +
      "service-experts/expert_search_box_process.php?select_search=" +
      select_search +
      "&select_city=" +
      select_city;
  });
...
jQuery(document).ready(function ($) {
  $("#place_filter_submit").on("click", function () {
    ...
    window.location.href =
      link +
      "places/place_search_box_process.php?select_search=" +
      select_search;
  });
});
