            ...
            <div class="cd-cen-intr">
                <div class="cd-cen-intr-inn">
                    <h2><?php echo $BIZBOOK['USER_DASHBOARD_WELCOME_TITLE']; ?>
                        <b><?php echo $user_details_row['first_name']; ?></b>
                    </h2>
                ...
                <div class="ud-payment ud-pro-link">
                    <div class="">
                        <div class="pay-lhs">
                            <div class="lis-pro-badg">
                                ...
                                <a href="<?php echo $PROFILE_URL . urlModifier($user_details_row['user_slug']); ?>" class="fclick" target="_blank">&nbsp;</a>
                            </div>
                        </div>
                        <div class="pay-rhs">
                            <ul>
                                ...
                                <li class="pro"><input type="text" value="<?php echo $PROFILE_URL . urlModifier($user_details_row['user_slug']); ?>" readonly></li>
                                <li class="pre"><a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($user_details_row['user_slug']); ?>"><?php echo $BIZBOOK['VIEW_MY_PROFILE_PAGE']; ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    ?>
                        <div class="bcmexpert_div">
                            <a class="bcmexpert" href="service-experts/create-service-expert-profile"><?php echo $BIZBOOK['BECOME_SERVICE_EXPERT']; ?></a>
                        </div>
                    <?php
                    }
                ...
                <div class="ud-cen-s3 ud-cen-s4">
                    ...
                    <div class="ud-payment ud-pro-link bus-pg">
                        <div class="pay-lhs">
                            <div class="lis-pro-badg">
                                <div>
                                    <img src="images/user/<?php if (($company_row['company_profile_photo'] == NULL) || empty($company_row['company_profile_photo'])) {
                                                                echo $footer_row['user_default_image'];
                                                            } else {
                        ...
                        <div class="pay-rhs">
                            <ul>
                                ...
                                <li class="pro"><input type="text" value="<?php echo $COMPANY_URL . urlModifier($company_row['company_slug']); ?>" readonly></li>
                                <li class="pre"><a target="_blank" href="<?php if ($company_row['company_name'] != NULL) {
                                                                                echo $COMPANY_URL . urlModifier($company_row['company_slug']);
                                                                            } else {
                                                                                echo "#!";
                ...
                <?php if ($footer_row['admin_expert_show'] == 1 && $user_details_row['setting_expert_show'] == 1) { ?>
                    ...
                    ?>
                        ...
                        <div class="ud-cen-s3 ud-cen-s4">
                            ...
                            <a href="service-experts/create-service-expert-profile" class="db-tit-btn"><?php echo $BIZBOOK['EDIT_SERVICE_EXPERT_PROFILE']; ?></a>
                            <div class="ud-payment ud-pro-link bus-pg">
                                <div class="pay-lhs">
                                    <div class="lis-pro-badg">
                                        <div>
                                            <img src="<?php echo $slash; ?>service-experts/images/services/<?php echo $service_expert_row['profile_image']; ?>" alt="">
                                            <h4><?php echo $service_expert_row['profile_name']; ?></h4>
                                            <p><?php echo $BIZBOOK['MEMBER_SINCE']; ?><?php echo dateFormatconverter($user_details_row['user_cdt']) ?></p>
                                            <span class="db-list-rat"><?php echo $star_rate_two; ?></span>
                                        </div>
                                        <a href="<?php echo $SERVICE_EXPERT_URL . urlModifier($service_expert_row['expert_slug']); ?>" class="fclick" target="_blank">&nbsp;</a>
                                    </div>
                                </div>
                                <div class="pay-rhs">
                                    <ul>
                                        ...
                                        <li class="pro"><input type="text" value="<?php echo $SERVICE_EXPERT_URL . urlModifier($service_expert_row['expert_slug']); ?>" readonly></li>
                                        <li class="pre"><a target="_blank" href="<?php echo $SERVICE_EXPERT_URL . urlModifier($service_expert_row['expert_slug']); ?>"><?php echo $BIZBOOK['VIEW_SERVICE_EXPERT_PROFILE_PAGE']; ?></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="ud-payment ud-pro-link bus-pg">
                ...
                <div class="pay-rhs">
                    <ul>
                        ...
                        <li><b><?php echo $BIZBOOK['PAGE_VIEWS']; ?> : </b>
                            <span><?php if ($job_profile_row['user_id'] != 0) {
                                        echo AddingZero_BeforeNumber(job_profile_pageview_count($job_profile_row['user_id']));
                                    } else {
                                        echo "00";
                                    } ?></span>
                        </li>
                    ...
                    <table class="responsive-table bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><?php echo $si; ?></td>
                                    <td><img src="<?php if ($listrow['profile_image'] != NULL || !empty($listrow['profile_image'])) {
                                    ...
                                    <td><span class="db-list-rat"><?php echo listing_pageview_count($listrow['listing_id']); ?></span>
                                    </td>
